...
func NovoRecebimentoRepository(conn *database.SQLStr) RecebimentoRepository {
...
func (s *recebimentoRepository) CriarRecebimento(r *models.Recebimento) error {
	var existe int
...
func (s *recebimentoRepository) ListarRecebimentos(page int) ([]models.Recebimento, error) {
...
func (s *recebimentoRepository) FiltrarDataRecebimentos(inicioData, fimData time.Time) ([]models.Recebimento, error) {
	var recebimentos []models.Recebimento
...
func (s *recebimentoRepository) ValidarRecebimento(r *models.Recebimento) (bool, string, error) {
