...
func NovoNotaRepository(conn *database.SQLStr) NotaRepository {
	return &notaRepository{
		db: conn.DB(),
	}
}

func (s *notaRepository) CriarNota(nota *models.Nota) (int, error) {
	var exists int
...
func (s *notaRepository) ListarNotas(page int) ([]models.Nota, error) {
...
func (s *notaRepository) FiltrarDataNota(inicioData, fimData time.Time) ([]models.Nota, error) {
	var notas []models.Nota
...
func (s *notaRepository) BuscarNotasPorNumero(numero string) ([]models.Nota, error) {
	var notas []models.Nota
